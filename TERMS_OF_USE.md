# Salvio — Terms of Use and End-User Licence Agreement
...
## 2. Acceptance, eligibility and age
...
## 3. Relationship to Apple, Google, and other app stores
...
## 6. What Salvio is — and what it is not
...
## 7. Additional terms for trainers, coaches and other Providers
...
**8.3 Assumption of risk.** You understand and voluntarily accept that physical exercise and training — whether supervised or not — involve inherent risks, including muscle strains, sprains, fractures, heat illness, cardiac events, other serious injury, permanent disability, and death. **You participate in any training or physical activity arranged through the Service entirely at your own risk and on your own judgement.** You are responsible for monitoring your own condition, disclosing relevant health information to your Provider, warming up appropriately, using equipment correctly, and stopping if you feel unwell.
...
## 9. Bookings, scheduling, attendance and check-in codes
...
- **You can manage your subscription and turn off auto-renewal at any time** in your app store account settings — for Apple, in Settings → your name → Subscriptions, or at `apps.apple.com/account/subscriptions`; for Google Play, in the Play Store under Payments and subscriptions → Subscriptions. Deleting the App does **not** cancel your subscription.
...
## 13. Public profiles, reviews and visibility
...
## 14. Search results, ranking and recommendations
...
## 15. Content moderation, reporting and complaints
...
## 17. Intellectual property and infringement claims
...
## 20. Maintenance, support and availability
...
## 24. Suspension, termination and account deletion
...
## 26. Changes to the Service and to these Terms
...
## 27. Governing law, consumer rights and disputes
...
Trade register: J39/412/2026 · CUI: 54645022
Email: **robertojudele@juroc.tech**
