...
Frontend-ul Salvio urmareste sa ofere o experienta mobila coerenta pentru toate rolurile de utilizator, pastrand in acelasi timp o integrare stricta cu API-ul backend. Din punct de vedere tehnic, obiectivele au fost:
...
Frontend-ul Salvio arata ca un stack mobil modern poate sustine fluxuri de business diverse intr-o aplicatie unica, cu UI coerent si contracte API clare. Organizarea pe feature-uri, impreuna cu RTK Query, ofera o baza buna pentru extinderea produsului.
