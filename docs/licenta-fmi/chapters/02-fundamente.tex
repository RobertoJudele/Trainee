...
Salvio urmeaza un model client-server clasic, dar bine delimitat: interfata mobila este separata de logica de business si de persistenta datelor. Aceasta separare simplifica testarea, mentenanta si, foarte important, controlul asupra punctelor sensibile de securitate.
