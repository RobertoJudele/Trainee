...
Arhitectura Salvio este distribuita si impartita clar pe straturi: aplicatie mobila, backend API, baza de date relationala si servicii externe. Structura monorepo pastreaza codul intr-un singur spatiu de lucru, dar fara sa amestece responsabilitatile dintre frontend si backend.
...
\caption{Diagrama de context a sistemului Salvio}
\end{figure}
